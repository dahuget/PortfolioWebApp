      ...
      <section className="home_gallery_area p_120">
        <div className="container">
          <div className="main_title">
            ...
            <p>(Click titles to link to Github source code)</p>
          </div>
        ...
        <div className="container">
          <div className="gallery_f_inner row imageGallery1">
            <div className="col-lg-4 col-md-4 col-sm-6 brand manipul design print">
              <div className="h_gallery_item">
                <div className="g_img_item">
                  ...
                  <a className="light" href="img/projects/climate-map.png"><img src="img/gallery/icon.png" alt /></a>
                </div>
            ...
            <div className="col-lg-4 col-md-4 col-sm-6 brand manipul creative">
              <div className="h_gallery_item">
                <div className="g_img_item">
                  <video className="img-fluid" src="img/projects/motoflash.png" alt />
                  <a className="light" href="img/projects/motoflash.png"><img src="img/gallery/icon.png" alt /></a>
                </div>
                <div className="g_item_text"> 
            ...
            <div className="col-lg-4 col-md-4 col-sm-6 manipul creative design print">
              <div className="h_gallery_item">
                <div className="g_img_item">
                  <img className="img-fluid" src="img/projects/virtualworld.png" alt />
                  <a className="light" href="img/projects/virtualworld.png"><img src="img/gallery/icon.png" alt /></a>
                </div>
                <div className="g_item_text">
            ...
            <div className="col-lg-4 col-md-4 col-sm-6 brand creative print">
              <div className="h_gallery_item">
                <div className="g_img_item">
                  ...
                  <a className="light" href="img/projects/vacancy-density-map.png"><img src="img/gallery/icon.png" alt /></a>
                </div>
                <div className="g_item_text">
            ...
            <div className="col-lg-4 col-md-4 col-sm-6 brand manipul design">
              <div className="h_gallery_item">
                <div className="g_img_item">
                  ...
                  <a className="light" href="img/projects/metro-homicides-map.png"><img src="img/gallery/icon.png" alt /></a>
                </div>
                <div className="g_item_text">
            ...
            <div className="col-lg-4 col-md-4 col-sm-6 brand creative">
              <div className="h_gallery_item">
                <div className="g_img_item">
                  ...
                  <a className="light" href="img/projects/ios-apps.png"><img src="img/gallery/icon.png" alt /></a>
                </div>
                <div className="g_item_text">
